package servlets;
	...
	public class ServletUsuarioRegister extends HttpServlet {
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			boolean leasing = Boolean.parseBoolean(request.getParameter("leasing"));
			
			String result = usuario.register(username, contrasena, nombre, apellidos, email, credito, leasing);
